...
class ViewController: UIViewController {
    ...
    static let reuseIdentify = "reusedCell"
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: ViewController.self.reuseIdentify)
        return tableView
    }()
...
extension ViewController:UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: ViewController.self.reuseIdentify, for: indexPath)
